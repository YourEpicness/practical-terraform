...
resource "aws_vpc" "mtc_vpc" {
  ...
  # So we can access resources by name
...
# Connect publiuc route table to public subnet using route table association
...
# If there aren't any routes available then use this private one
